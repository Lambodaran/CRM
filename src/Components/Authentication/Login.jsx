  ...
  <div className="relative w-full max-w-7xl h-[700px] bg-white shadow-2xl rounded-2xl overflow-hidden">
    ...
    <div
      className={`absolute top-0 left-0 w-full h-full flex transition-transform duration-700 ${
        showSignup ? "md:-translate-x-1/2" : "translate-x-0"
      }`}
    >
      {/* Login Panel - now full width on mobile */}
      <div className="w-full md:w-1/2 flex flex-col justify-center items-center p-6 sm:p-10 bg-white relative z-10">
        <nav
      ...
      {/* Right side image + text - hidden on mobile */}
      <div className="hidden md:block absolute top-0 right-0 w-1/2 h-full overflow-hidden rounded-r-2xl">
        <img
