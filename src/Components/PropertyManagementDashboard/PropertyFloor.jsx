...
//   //   if (floorToEdit) {
//   //     setFormData({
//   //       building: floorToEdit.building._id,
...
//     if (floorToEdit) {
//       setFormData({
//         building: floorToEdit.building._id || floorToEdit.building, // Handle both cases
//         floorNumber: floorToEdit.floorNumber.toString(),
//         totalUnits: floorToEdit.totalUnits.toString(),
//         keyPlan: floorToEdit.keyPlan || "",
//       });
...
//           // Assuming the response is a single building object
...
//     navigate("/PropertyUnit", { state: { id } });
//   };
